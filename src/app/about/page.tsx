        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-charcoal dark:text-ghost-white">
              About <FlipWords words={["brokerConnect", "Our Mission", "Our Team", "Our Values"]} className="text-light-blue" />
            </h1>
            <p className="text-lg text-paynes-gray dark:text-light-blue max-w-3xl mx-auto">
              We're on a mission to make trading safer and more accessible by connecting traders with verified brokers, prop firms, and mentors.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            <div>
              <h2 className="text-2xl md:text-4xl font-bold mb-6 text-charcoal dark:text-ghost-white">Our Story</h2>
            ...
            <div className="bg-ghost-white dark:bg-charcoal p-8 rounded-xl border border-paynes-gray/20">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 text-charcoal dark:text-ghost-white">Our Mission</h2>
              <div className="space-y-4 text-paynes-gray dark:text-light-blue">
                <p>
          ...
          <div className="mb-20">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center text-charcoal dark:text-ghost-white">
              Our Core <span className="text-light-blue">Values</span>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-ghost-white dark:bg-charcoal p-8 rounded-xl border border-paynes-gray/20 hover:border-light-blue/50 transition-all duration-300">
                <div className="h-16 w-16 bg-light-blue/20 rounded-full flex items-center justify-center mb-6">
                  <span className="text-light-blue text-2xl">✓</span>
                </div>
          ...
          <div className="bg-ghost-white dark:bg-charcoal p-8 md:p-12 rounded-xl border border-paynes-gray/20 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-charcoal dark:text-ghost-white">
              Join Our Mission
            </h2>
